...
class ScanSubmissionTasks(TaskSet):
    ...
    def list_scans(self):
        ...
        self.client.get(f"/api/v1/scans/?page={page}&page_size={page_size}", name="/api/v1/scans/ [GET]")
    ...
    def get_scan_detail(self):
        ...
        self.client.get(f"/api/v1/scans/{scan_id}/", name="/api/v1/scans/{id}/ [GET]")
    ...
    def get_scan_findings(self):
        ...
        scan_id = random.choice(self.scan_ids)
        self.client.get(f"/api/v1/scans/{scan_id}/findings/", name="/api/v1/scans/{id}/findings/ [GET]")
...
class DashboardTasks(TaskSet):
    ...
    def get_severity_breakdown(self):
        ...
        self.client.get("/api/v1/dashboard/severity-breakdown/", name="/api/v1/dashboard/severity-breakdown/")

    @task(1)
    def get_recent_activity(self):
        """Get recent activity."""
        self.client.get("/api/v1/dashboard/recent-activity/", name="/api/v1/dashboard/recent-activity/")
...
class WebhookTasks(TaskSet):
    ...
    def list_webhooks(self):
        ...
        self.client.get("/api/v1/webhooks/", name="/api/v1/webhooks/")

    @task(1)
    def get_webhook_stats(self):
        """Get webhook delivery statistics."""
        self.client.get("/api/v1/webhooks/stats/", name="/api/v1/webhooks/stats/")
...
class AgentUser(HttpUser):
    ...
    def submit_scan(self):
        ...
        self.client.post("/api/v1/scans/", json=payload, name="/api/v1/scans/ [Agent]")
