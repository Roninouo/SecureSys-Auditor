...
class APITester:
    ...
    def test_systems_list_unauthenticated(self) -> TestResult:
        ...
        result = TestResult(
            name="Systems List (Unauthenticated)",
    ...
    def test_scans_list_unauthenticated(self) -> TestResult:
        ...
        result = TestResult(
            name="Scans List (Unauthenticated)",
...
def print_next_steps(report: TestReport):
    ...
    connection_errors = [r for r in report.results if r.error and ("Connection" in r.error or "refused" in str(r.error).lower())]
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="SecureSys Auditor - Centralized Runner",
