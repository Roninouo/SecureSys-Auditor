...
class HealthCheckView(APIView):
    ...
    def get(self, request):
        return Response({"status": "healthy", "service": "SecureSys Auditor API", "version": "2.0.0"})
...
class ReadinessCheckView(APIView):
    ...
    def get(self, request):
        ...
        return Response({"status": "ready" if all_healthy else "not_ready", "checks": checks}, status=http_status)
