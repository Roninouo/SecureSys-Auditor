    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('viewer', 'Viewer'), ('auditor', 'Auditor'), ('admin', 'Admin')], default='viewer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('category', models.CharField(choices=[('access_control', 'Access Control'), ('configuration', 'Configuration'), ('patch_management', 'Patch Management'), ('network', 'Network'), ('authentication', 'Authentication'), ('encryption', 'Encryption'), ('logging', 'Logging'), ('other', 'Other')], db_index=True, max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maturity_level', models.CharField(blank=True, choices=[('reactive', 'Reactive'), ('basic', 'Basic'), ('managed', 'Managed'), ('optimized', 'Optimized')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('environment', models.CharField(choices=[('development', 'Development'), ('staging', 'Staging'), ('production', 'Production'), ('testing', 'Testing')], default='development', max_length=20)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['hostname'], name='systems_hostnam_8dbb20_idx'), models.Index(fields=['environment'], name='systems_environ_83cff8_idx'), models.Index(fields=['last_seen'], name='systems_last_se_d34378_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('overall_level', models.IntegerField(choices=[(1, 'Level 1 - Initial/Ad Hoc'), (2, 'Level 2 - Developing'), (3, 'Level 3 - Defined'), (4, 'Level 4 - Managed/Optimized')], default=1)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('scan', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='maturity_assessment', to='core.scan')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='scan',
            name='system',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scans', to='core.system'),
        ),
        migrations.CreateModel(
            name='Recommendation',
            fields=[
                ...
                ('effort', models.CharField(choices=[('low', 'Low (< 1 hour)'), ('medium', 'Medium (1-4 hours)'), ('high', 'High (4+ hours)')], default='medium', max_length=10)),
                ('title', models.CharField(max_length=255)),
                ('description', models.TextField()),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('finding', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recommendations', to='core.finding')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='finding',
            name='scan',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='findings', to='core.scan'),
        ),
        migrations.CreateModel(
            name='AuditLog',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('action', models.CharField(choices=[('LOGIN', 'User Login'), ('LOGOUT', 'User Logout'), ('CREATE_SYSTEM', 'System Created'), ('UPDATE_SYSTEM', 'System Updated'), ('DELETE_SYSTEM', 'System Deleted'), ('SUBMIT_SCAN', 'Scan Submitted'), ('VIEW_SCAN', 'Scan Viewed'), ('GENERATE_REPORT', 'Report Generated'), ('UPDATE_FINDING', 'Finding Updated'), ('USER_CREATED', 'User Created'), ('USER_UPDATED', 'User Updated'), ('ROLE_CHANGED', 'User Role Changed')], db_index=True, max_length=30)),
