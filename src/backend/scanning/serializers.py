...
class FindingDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Finding
        fields = [
            'id', 'scan', 'scan_info', 'category', 'severity', 'title',
            'description', 'evidence', 'cwe_id', 'cvss_score',
            'is_resolved', 'resolved_at', 'created_at', 'updated_at',
            'recommendations'
        ]
...
class ScanSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Scan
        fields = [
            'id', 'system', 'system_info', 'scan_type', 'scan_date', 'status',
...
class ScanListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Scan
        fields = [
            'id', 'system', 'system_hostname', 'scan_type', 'scan_date',
...
class ScanSubmitSerializer(serializers.Serializer):
    ...
    scan_type = serializers.ChoiceField(
        choices=Scan.ScanType.choices,
        default=Scan.ScanType.FULL
    )
