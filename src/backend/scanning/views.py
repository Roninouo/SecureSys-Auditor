...
class SystemViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        logger.info(f"System registered: {system.hostname}", extra={
    ...
    def perform_destroy(self, instance):
        ...
        logger.info(f"System deactivated: {instance.hostname}", extra={
...
class ScanViewSet(viewsets.ModelViewSet):
    ...
    @action(
        detail=False,
        methods=['post'],
        permission_classes=[AllowAgentOrAuthenticated]
    )
    def submit(self, request):
        ...
        logger.info(f"Scan submitted: {scan.id}", extra={
            'scan_id': str(scan.id),
    ...
    def summary(self, request, pk=None):
        ...
        findings_by_severity = scan.findings.values('severity').annotate(
            count=Count('id')
        )
        
        findings_by_category = scan.findings.values('category').annotate(
            count=Count('id')
        )
        ...
        return Response({
            ...
            'findings_by_category': {
                ...
                for item in findings_by_category
            },
            'duration': (
...
class FindingViewSet(viewsets.ModelViewSet):
    ...
    def resolve(self, request, pk=None):
        ...
        logger.info(f"Finding resolved: {finding.id}", extra={
