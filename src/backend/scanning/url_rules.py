            ...
            return {
                ...
                'recommendations': [{
                    ...
                    'steps': [
                        ...
                        'For Nginx: add_header Strict-Transport-Security "max-age=31536000; includeSubDomains; preload" always;',
    ...
    def evaluate(self, scan_result: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        if hsts_issues:
            return {
                ...
                'description': 'The HSTS header is present but has configuration weaknesses that reduce its effectiveness.',
                'evidence': {
                    'url': scan_result.get('url'),
                    'header': 'Strict-Transport-Security',
            ...
            return {
                ...
                'recommendations': [{
                    ...
                    'steps': [
                        ...
                        'Example starter policy: "default-src \'self\'; script-src \'self\'; style-src \'self\' \'unsafe-inline\'"',
