    ...
    def handle(self, *args, **options):
        ...
        try:
            with transaction.atomic():
                ...
                scans, findings, recommendations = self.create_scans_and_findings(systems, max_scans)
    ...
    def create_scans_and_findings(self, systems, max_scans):
        ...
        for system in systems:
            ...
            for _ in range(num_scans):
                ...
                status = random.choices(["completed", "processing", "failed"], weights=[85, 10, 5], k=1)[0]
        ...
        return {
            "critical": [
                ...
                },
                {
                    ...
                    "description": "Credentials exposed in config.",
            ...
            "high": [
                {
                    ...
                    "description": "OpenSSL with known vulnerabilities.",
                    "category": "patch_management",
                    "cwe_id": "CWE-327",
                    "cvss_score": 8.1,
                },
                {
                    ...
                    "description": "Direct root login allowed via SSH.",
                    "category": "configuration",
                    "cwe_id": "CWE-250",
                    "cvss_score": 7.5,
                },
                {
                    ...
                    "description": "Critical HTTP headers missing.",
                    "category": "configuration",
                    "cwe_id": "CWE-693",
                    "cvss_score": 7.2,
                },
            ...
            "medium": [
                {
                    ...
                    "description": "Deprecated TLS versions enabled.",
                    "category": "encryption",
                    "cwe_id": "CWE-326",
                    "cvss_score": 5.3,
                },
                ...
                },
                {
                    ...
                    "description": "Sessions valid for too long.",
                    "category": "authentication",
                    "cwe_id": "CWE-613",
                    "cvss_score": 5.4,
                },
            ...
            "low": [
                ...
                },
                {
                    ...
                    "description": "No DNS CAA records.",
                    "category": "network",
                    "cwe_id": "CWE-295",
                    "cvss_score": 3.7,
                },
