...
export const systemsApi = {
  ...
  getScans: async (systemId: string) => {
    const response = await api.get(`/systems/${systemId}/scans/`)
    return response.data
  },
}
...
export const scansApi = {
  ...
  submit: async (data: { system_id: string; scan_payload: object }) => {
    const response = await api.post('/scans/submit/', data)
    return response.data
  },
...
export const findingsApi = {
  ...
  resolve: async (id: string) => {
    const response = await api.post(`/findings/${id}/resolve/`)
    return response.data
  },
  
  getRecommendations: async (findingId: string) => {
    const response = await api.get(`/findings/${findingId}/recommendations/`)
    return response.data
  },
}
